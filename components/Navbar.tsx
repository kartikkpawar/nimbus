...
import { LucideChevronRight, LucideMenu, LucideXCircle } from "lucide-react";
      ...
      <div className="flex gap-3 md:gap-4">
        ...
        >
          <span className="font-bold-slanted relative z-10 flex items-center gap-2 text-xl uppercase">
            Buy
            <LucideChevronRight className="size-5 group-hover:translate-x-0.5 motion-safe:transition-transform motion-safe:duration-200" />
          </span>
        </button>
    ...
    <li>
      ...
      >
        ...
        <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-gray-100 text-gray-400 group-hover:bg-[#01A7E1] group-hover:text-white motion-safe:transition">
          <LucideChevronRight className="size-5 translate-x-px" />
        </div>
      </Link>
    </li>
  );
