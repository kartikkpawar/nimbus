        ...
        <div className="mt-12 rounded-2xl border border-gray-200 bg-white p-8 shadow-lg shadow-black/5 backdrop-blur-xl">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between border-b border-gray-100 py-3">
              ...
              <span className="text-gray-900">dummy_email@example.com</span>
            </div>
            ...
            <div className="flex items-center justify-between border-b border-gray-100 py-3">
              ...
              <span className="font-semibold text-gray-900">$127.99</span>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100">
                <LucideMail className="h-6 w-6 text-[#01A7E1]" />
              </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100">
                <LucidePackageOpen className="h-6 w-6 text-[#01A7E1]" />
              </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-100">
                <LucidePackageCheck className="h-6 w-6 text-[#01A7E1]" />
              </div>
        ...
        <div className="mt-12 flex flex-col justify-center gap-4 sm:flex-row">
          ...
          >
            <span className="flex items-center gap-2 text-lg">
              <LucideCircleHelp className="h-5 w-5" />
              Need Help?
            </span>
          </Link>
        </div>
